    ...
    def create_webhook(self):
        ...
        webhook_data = {
            ...
            'body_template': (
                ...
                '},'
                '"status":{"value":"{{ data.status.value }}","label":"{{ data.status.label }}"},'
                '"device_type":{"id":{{ data.device_type.id }},"model":"{{ data.device_type.model }}","slug":"{{ data.device_type.slug }}","manufacturer":{"id":{{ data.device_type.manufacturer.id }},"name":"{{ data.device_type.manufacturer.name }}","slug":"{{ data.device_type.manufacturer.slug }}"}},'
                '"role":{"id":{{ data.role.id }},"name":"{{ data.role.name }}","slug":"{{ data.role.slug }}"},'
                '"site":{"id":{{ data.site.id }},"name":"{{ data.site.name }}","slug":"{{ data.site.slug }}"}'
                '}'
                '}'
            )
        }
